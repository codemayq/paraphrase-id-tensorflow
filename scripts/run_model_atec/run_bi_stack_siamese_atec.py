...
from duplicate_questions.data.instances.atec_instance import AtecInstance
from duplicate_questions.models.siamese_bilstm.siamese_bi_stack_lstm import SiameseBiStackLSTM
...
def main():
    ...
    argparser.add_argument("--num_epochs", type=int, default=100,
                           help=("Number of epochs to perform in "
                                 "training."))
    argparser.add_argument("--l2_lambda", type=float, default=0.0003,
                           help=("Number of epochs to perform in "
                                 "training."))
    argparser.add_argument("--early_stopping_patience", type=int, default=100,
                           help=("number of epochs with no validation "
                                 ...
                                 "will be stopped"))
    argparser.add_argument("--num_sentence_words", type=int, default=21,
    ...
    argparser.add_argument("--output_keep_prob", type=float, default=0.8,
    ...
    if mode == "train":
        ...
        data_manager = DataManager(AtecInstance)
    ...
    model = SiameseBiStackLSTM(vars(config))
    model.build_graph()
    ...
    if mode == "train":
        ...
        # for x, y in data_manager.data_indexer.word_indices.items():
        #     print(x)
